...
var ja = {
  ...
  responseFormatInstruction: 'JSON\u306E\u307F\u3067\u5FDC\u7B54\u3057\u3066\u304F\u3060\u3055\u3044\uFF1A\u30A2\u30AF\u30C6\u30A3\u30D6\u306A\u30C1\u30B1\u30C3\u30C8\u3054\u3068\u306B1\u3064\u306E\u30AA\u30D6\u30B8\u30A7\u30AF\u30C8\u306E\u914D\u5217\u3002\u5404\u30AA\u30D6\u30B8\u30A7\u30AF\u30C8\u306F\u3001\u30C1\u30B1\u30C3\u30C8\u306E\u30AD\u30FC\u3068\u5B8C\u5168\u306B\u7B49\u3057\u3044\u30AD\u30FC\u30921\u3064\u3060\u3051\u6301\u3064\u5FC5\u8981\u304C\u3042\u308A\u3001\u305D\u306E\u5024\u306F\u5BFE\u5FDC\u3059\u308B\u30C1\u30B1\u30C3\u30C8\u306E\u30EC\u30B9\u30DD\u30F3\u30B9\u30B9\u30AD\u30FC\u30DE\u306B\u5F93\u3046\u5FC5\u8981\u304C\u3042\u308A\u307E\u3059\u3002\u4F8B: [ { "\u30C1\u30B1\u30C3\u30C8\u30AD\u30FC" : { ... } } ]',
...
var zh = {
  ...
  responseFormatInstruction: '\u4EC5\u4EE5 JSON \u56DE\u7B54\uFF1A\u4E00\u4E2A\u5BF9\u8C61\u6570\u7EC4\uFF0C\u6BCF\u4E2A\u6D3B\u52A8\u5DE5\u5355\u4E00\u4E2A\u5BF9\u8C61\u3002\u6BCF\u4E2A\u5BF9\u8C61\u5FC5\u987B\u6070\u597D\u6709\u4E00\u4E2A\u7B49\u4E8E\u5DE5\u5355\u952E\u7684\u952E\uFF0C\u5176\u503C\u5FC5\u987B\u7B26\u5408\u5BF9\u5E94\u5DE5\u5355\u7684\u54CD\u5E94\u6A21\u5F0F\u3002\u793A\u4F8B\uFF1A[ { "\u5DE5\u5355\u952E" : { ... } } ]',
...
var es = {
  ...
  addFileButton: "A\xF1adir",
  removeFile: "Quitar",
  tickets: "Tickets",
  ticketsDescription: "Los tickets describen las tareas concretas que debe completar el agente. Cada ticket puede tener una descripci\xF3n, una explicaci\xF3n y un esquema de respuesta esperado. Un ticket marcado como \xABhecho\xBB se excluye del prompt.",
  response: "Respuesta de la IA",
  noPrompt: "Sin prompt",
  noPromptDesc: "Define un prompt de sistema para guiar a la IA",
  noFiles: "Sin archivos",
  noFilesDesc: "A\xF1ade archivos fuente (especificaciones, esquemas)",
  noTickets: "Sin tickets",
  noTicketsDesc: "A\xF1ade tickets para estructurar las tareas de la IA",
  noResponse: "Sin respuesta",
  noResponseDesc: "Haz clic en \xABGenerar\xBB para obtener una respuesta",
  ...
  additionalContextPlaceholder: "A\xF1ade informaci\xF3n contextual adicional (fragmentos de c\xF3digo, logs, restricciones...)",
  viewPrompt: "Prompt completo",
  copyPrompt: "Copiar el prompt",
  promptCopied: "\xA1Prompt copiado!",
  promptPreview: "Prompt completo ensamblado",
  promptCharCount: "caracteres",
  languageLabel: "Idioma",
  languageDescription: "Idioma de visualizaci\xF3n de las etiquetas del panel",
  settings: "Ajustes",
  selectProvider: "Proveedor de IA",
  enableProvider: "Activado",
  disableProvider: "Desactivado",
  helpSection: "Ayuda",
  docLinks: "Documentaci\xF3n",
  modelLabel: "Modelo",
  ...
  noExistingContentDesc: "Este ticket a\xFAn no tiene valor",
  responseValid: "Formato de respuesta v\xE1lido",
  responseInvalid: "Formato de respuesta inv\xE1lido",
  responseFormatInstruction: 'Responde SOLO en JSON: un array de objetos, uno por ticket activo. Cada objeto debe tener exactamente una clave igual a la clave del ticket, y su valor debe respetar el esquema de respuesta del ticket correspondiente. Ejemplo: [ { "clave-del-ticket" : { ... } } ]',
  validationErrorNotJson: "La respuesta no es un JSON v\xE1lido",
  ...
  errorNoStream: "El handler no devolvi\xF3 un stream",
  errorUnknown: "Error desconocido",
  errorStreaming: "Error de streaming",
  infoButton: "Info",
  infoSheetTitle: "OneShot AI Panel",
  infoSheetDescription: "Asistente de generaci\xF3n impulsado por IA: archivos fuente, tickets a tratar, respuestas JSON validadas y bucle de correcci\xF3n.",
  infoOverviewTitle: "Visi\xF3n general",
  infoOverviewBody: "OneShot AI Panel es un asistente impulsado por un modelo de lenguaje. Describe el objetivo, proporciona archivos fuente y tickets a tratar, y el modelo genera una respuesta JSON validada contra el esquema de cada ticket.\n\nLa generaci\xF3n se transmite en tiempo real con el razonamiento del modelo, y la respuesta se muestra como JSON indentado. Una revisi\xF3n compara luego cada propuesta con el contenido existente antes de integrarla.\n\nEl panel es configurable (proveedor, modelo, idioma) y totalmente localizable. Esta ayuda se muestra en el idioma activo.",
  infoPromptTitle: "El prompt",
  infoPromptBody: "El prompt se compone de tres campos:\n\u2022 Prompt del sistema: el rol y las reglas del modelo (siempre se env\xEDa).\n\u2022 Instrucciones adicionales: tu solicitud precisa (opcional).\n\u2022 Contexto adicional: informaci\xF3n complementaria (opcional).\n\nEl bot\xF3n \xABVer el prompt\xBB muestra el mensaje exacto que se enviar\xE1, y \xABCopiar\xBB permite reutilizarlo.",
  infoFilesTitle: "Archivos fuente",
  infoFilesBody: "Proporciona archivos o URLs (servidor, CDN, drive) que el modelo lea por s\xED mismo.\n\n\u2022 Un archivo se define por una etiqueta y una ruta absoluta o URL.\n\u2022 Incluir / Excluir activa o desactiva un archivo en el prompt.\n\u2022 Un archivo marcado como \xABno presente\xBB simplemente se ignora al enviar.\n\u2022 El campo al final de la secci\xF3n a\xF1ade una ruta o URL al vuelo.\n\nEl panel no convierte el contenido de los archivos: el modelo los lee.",
  infoTicketsTitle: "Tickets",
  infoTicketsBody: "Los tickets describen las tareas a completar. Cada ticket de nivel superior exige un esquema de respuesta (JSON Schema) que describe el formato esperado para su salida.\n\n\u2022 Descripci\xF3n: el objetivo del ticket.\n\u2022 Explicaci\xF3n: el m\xE9todo a seguir.\n\u2022 Contenido existente: contenido ya presente para enriquecer o reemplazar. Se compara con la propuesta de la IA en la revisi\xF3n antes de integrar.\n\u2022 Sub-tickets: divisi\xF3n de la tarea en sub-pasos.\n\nUn ticket de nivel superior sin esquema se se\xF1ala con una advertencia roja.",
  infoValidationTitle: "Validaci\xF3n de la respuesta",
  infoValidationBody: "El modelo debe responder SOLO en JSON: un array de objetos, uno por ticket activo, cada uno con la forma { 'clave-del-ticket': valor }. Cada valor debe seguir el esquema de respuesta del ticket.\n\nAl terminar la generaci\xF3n, la respuesta se valida autom\xE1ticamente:\n\u2022 insignia verde \xABFormato de respuesta v\xE1lido\xBB;\n\u2022 insignia roja \xABFormato de respuesta inv\xE1lido\xBB con el detalle de los errores por ticket.\n\nLa respuesta mostrada se reformatea autom\xE1ticamente como JSON indentado (2 espacios) para facilitar la lectura.\n\nEl modo de validaci\xF3n es configurable en \xABAjustes\xBB:\n\u2022 Avisar: la generaci\xF3n sigue siendo posible, la invalidez solo se se\xF1ala.\n\u2022 Bloquear la integraci\xF3n: el bot\xF3n de integraci\xF3n permanece desactivado mientras la respuesta sea inv\xE1lida.\n\nDesde el c\xF3digo, tambi\xE9n puedes proporcionar tu propio parser (prop \xABparser\xBB) para controlar por completo la lectura de la respuesta: tiene prioridad sobre la validaci\xF3n autom\xE1tica.",
  infoFeedbackTitle: "Bucle de correcci\xF3n",
  infoFeedbackBody: "Cuando la validaci\xF3n falla, aparece un bloque \xABError\xBB con la lista detallada de errores y una casilla \xABIncluir los errores en el prompt\xBB.\n\nAl relanzar la generaci\xF3n, estos errores se inyectan en el prompt para decirle al modelo lo que debe evitar y recordarle el formato esperado. Desmarca la casilla para relanzar sin este feedback.",
  ...
  diffEmptyValue: "(vac\xEDo)",
  diffInclude: "Incluir este ticket",
  plugSelected: "Integrar la selecci\xF3n",
  diffViewFull: "Diffs",
...
var ar = {
  ...
  removeFile: "\u0625\u0632\u0627\u0644\u0629",
  tickets: "\u0627\u0644\u062A\u0630\u0627\u0643\u0631",
  ticketsDescription: "\u062A\u0635\u0641 \u0627\u0644\u062A\u0630\u0627\u0643\u0631 \u0627\u0644\u0645\u0647\u0627\u0645 \u0627\u0644\u0645\u0644\u0645\u0648\u0633\u0629 \u0627\u0644\u062A\u064A \u0639\u0644\u0649 \u0627\u0644\u0648\u0643\u064A\u0644 \u0625\u0646\u062C\u0627\u0632\u0647\u0627. \u064A\u0645\u0643\u0646 \u0623\u0646 \u062A\u062D\u062A\u0648\u064A \u0643\u0644 \u062A\u0630\u0643\u0631\u0629 \u0639\u0644\u0649 \u0648\u0635\u0641 \u0648\u062A\u0641\u0633\u064A\u0631 \u0648\u0645\u062E\u0637\u0637 \u0627\u0633\u062A\u062C\u0627\u0628\u0629 \u0645\u062A\u0648\u0642\u0639. \u0627\u0644\u062A\u0630\u0643\u0631\u0629 \u0627\u0644\u0645\u064F\u0639\u0644\u064E\u0651\u0645\u0629 \xAB\u0645\u0646\u062C\u0632\u0629\xBB \u062A\u064F\u0633\u062A\u0628\u0639\u062F \u0645\u0646 \u0627\u0644\u0645\u0648\u062C\u0647.",
  ...
  noResponseDesc: "\u0627\u0646\u0642\u0631 \u0639\u0644\u0649 \xAB\u062A\u0648\u0644\u064A\u062F\xBB \u0644\u0644\u062D\u0635\u0648\u0644 \u0639\u0644\u0649 \u0627\u0633\u062A\u062C\u0627\u0628\u0629",
  ...
  responseFormatInstruction: '\u0623\u062C\u0628 \u0641\u0642\u0637 \u0628\u0635\u064A\u063A\u0629 JSON: \u0645\u0635\u0641\u0648\u0641\u0629 \u0645\u0646 \u0627\u0644\u0643\u0627\u0626\u0646\u0627\u062A\u060C \u0643\u0627\u0626\u0646 \u0644\u0643\u0644 \u062A\u0630\u0643\u0631\u0629 \u0646\u0634\u0637\u0629. \u064A\u062C\u0628 \u0623\u0646 \u064A\u062D\u062A\u0648\u064A \u0643\u0644 \u0643\u0627\u0626\u0646 \u0639\u0644\u0649 \u0645\u0641\u062A\u0627\u062D \u0648\u0627\u062D\u062F \u062A\u0645\u0627\u0645\u064B\u0627 \u064A\u0633\u0627\u0648\u064A \u0645\u0641\u062A\u0627\u062D \u0627\u0644\u062A\u0630\u0643\u0631\u0629\u060C \u0648\u0623\u0646 \u062A\u0644\u062A\u0632\u0645 \u0642\u064A\u0645\u062A\u0647 \u0628\u0645\u062E\u0637\u0637 \u0627\u0633\u062A\u062C\u0627\u0628\u0629 \u0627\u0644\u062A\u0630\u0643\u0631\u0629 \u0627\u0644\u0645\u0642\u0627\u0628\u0644\u0629. \u0645\u062B\u0627\u0644: [ { "\u0645\u0641\u062A\u0627\u062D-\u0627\u0644\u062A\u0630\u0643\u0631\u0629" : { ... } } ]',
...
En mode compil\xE9 (d\xE9pendance npm), cr\xE9e la route en une ligne : export { GET, POST, PUT, PATCH, DELETE, OPTIONS } from "one-shot-ai-panel/zen-proxy" dans app/api/zen/v1/[...path]/route.ts (ou lance pnpm exec one-shot-ai-panel install --proxy-only).
...
Attention : Zen est un gateway chat (pas d'agent) : pas de permissions, questions, tools ni diff.`,
  ...
  [AiPanelLanguage.Es]: {
    [ProviderType.Opencode]: {
      description: "Conexi\xF3n nativa al servidor OpenCode",
      help: "Abre una terminal y lanza el servidor:\n\n  opencode serve [--port <number>] [--hostname <string>] [--cors <origin>]\n\nValores por defecto: port=4096, hostname=127.0.0.1.\n--cors se puede repetir para permitir varios or\xEDgenes.\n\nPara activar la autenticaci\xF3n, define la variable de entorno:\n  OPENCODE_SERVER_PASSWORD=tu-contrase\xF1a\n\nLuego introduce la contrase\xF1a abajo.",
      modelPlaceholder: "Modelo (d\xE9jalo vac\xEDo para el predeterminado del servidor)",
      apiKeyLabel: "Contrase\xF1a (opcional)",
      apiKeyPlaceholder: "OPENCODE_SERVER_PASSWORD",
      baseUrlLabel: "URL del servidor",
      baseUrlPlaceholder: "http://localhost:4096",
      docLinks: [
        { label: "Documentaci\xF3n de OpenCode", url: "https://opencode.ai/docs" },
...
// src/module/i18n/languages.ts
var AiPanelLanguageNames = {
  [AiPanelLanguage.Fr]: "Fran\xE7ais",
  [AiPanelLanguage.En]: "English",
  [AiPanelLanguage.Ja]: "\u65E5\u672C\u8A9E",
  [AiPanelLanguage.Zh]: "\u7B80\u4F53\u4E2D\u6587",
  [AiPanelLanguage.Es]: "Espa\xF1ol",
  [AiPanelLanguage.Ar]: "\u0627\u0644\u0639\u0631\u0628\u064A\u0629"
};
var AI_PANEL_LANGUAGES = Object.values(AiPanelLanguage);
function aiPanelLanguageFromLocale(locale) {
  switch (locale) {
    case "ja":
      ...
      /* @__PURE__ */ jsxs15("div", { className: "flex-1 overflow-y-auto no-scrollbar p-4 space-y-5", children: [
        /* @__PURE__ */ jsxs15("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxs15(Select, { value: language, onValueChange: (v) => onLanguageChange(v), children: [
            /* @__PURE__ */ jsx22(SelectTrigger, { className: "h-8 text-xs w-full cursor-pointer", children: AiPanelLanguageNames[language] }),
            /* @__PURE__ */ jsx22(SelectContent, { children: AI_PANEL_LANGUAGES.map((lang) => /* @__PURE__ */ jsx22(SelectItem, { value: lang, className: "text-xs cursor-pointer", children: AiPanelLanguageNames[lang] }, lang)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs15("div", { className: "space-y-1.5", children: [
